...
import { DataObject, DisplayProps } from "./components/types";
...
const App: React.FC = () => {
  ...
  const [address, setAddress] = useState<string>(
    "123 Main Street, Faridpur, Bangladesh"
  );
  ...
  const handleUpdate = (updatedData: Partial<DisplayProps>) => {
    ...
    if (updatedData.totalSale !== undefined)
      setTotalSale(updatedData.totalSale);
  };
